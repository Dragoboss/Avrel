...
module.exports = {
    ...
    CreateIntent: async function(parts, displayName, parameters, paramName) {
        const projectId = "";
        ...
        if (parameters !== "No") {
            parameter = {
                ...
                entityTypeDisplayName: eval("@" + paramName),
                value: paramName,
                mandatory: true,
                prompts: eval("For which " + paramName + "?"),
            };
            for (var p of parts) {
                part = {
                    texts: p,
                    entityType: eval("@" + paramName),
                    alias: paramName,
                };
